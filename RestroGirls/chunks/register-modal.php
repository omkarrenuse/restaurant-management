	...
	<div id="modal2" class="modal">
	    <div class="modal-content center">
	      ...
	      <form>
	          ...
	          <input onclick="return isAlphaNumSpace(event);" id="name_reg" type="text" class="validate">
	          <label for="name_reg">Full Name</label>
	          
	        </div>

	        <div class="input-field col s12">
	          <input onclick="return isEmail(event);" id="email_reg" type="email" class="validate">
