<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">HEALTHY BITES</a>
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +919657857216, +919309501577. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
